...
class Checkout:
    class Discount:
        def __init__(self, itemCount, price):
    ...
    def addDiscount(self, item, itemCount, price):
        discount = self.Discount(itemCount, price)
    ...
    def calculateItemDiscountedTotal(self, item, count, discount):
        total = 0
        nbrOfDiscounts = count/discount.itemCount
        total += nbrOfDiscounts * discount.price
        remaining = count % discount.itemCount
